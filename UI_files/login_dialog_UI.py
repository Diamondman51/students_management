...
################################################################################
## Form generated from reading UI file 'Login_UIJLmsFK.ui'
##
...
"}")
        ...
        self.login_widget.setGeometry(QRect(230, 150, 490, 391))
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/images/github_icon.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/images/facebook_icon.png", QSize(), QIcon.Normal, QIcon.Off)
